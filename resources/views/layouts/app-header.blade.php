<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            {{-- <a href="{{ route('dashboard.index') }}" class="xl:hidden flex items-center gap-2">
                <img class="dark:hidden h-8 w-auto" src="{{ asset('images/logo/logo.svg') }}" alt="Logo Light" />
                <img class="hidden dark:block h-8 w-auto" src="{{ asset('images/logo/logo-dark.svg') }}"
                    alt="Logo Dark" />
            </a> --}}
