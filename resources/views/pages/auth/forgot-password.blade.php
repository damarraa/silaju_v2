                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        ...
                        <div>
                            ...
                            <div class="relative py-3 sm:py-1"></div>
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            Email Terdaftar<span class="text-error-500">*</span>
                                        </label>
                                    ...
                                    <div class="text-center">
                                        <a href="{{ route('login') }}" class="text-sm text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
