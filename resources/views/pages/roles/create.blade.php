...
@section('content')
    <div class="mb-6">
        <h2 class="text-title-md2 font-bold text-black dark:text-white">Tambah Role & Akses</h2>
    </div>
    ...
    <div class="rounded-lg border border-gray-200 bg-white shadow-default dark:border-gray-800 dark:bg-gray-900">
        <form action="{{ route('roles.store') }}" method="POST" class="p-6">
            ...
            <div class="mb-6 max-w-lg">
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Admin Gudang"
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {{-- Kita kelompokkan permission secara manual/logic view --}}
                    @php
                        // Grouping Logic: Ambil kata pertama sebelum '_' (user_create -> user)
                            ...
                            <div class="space-y-2">
                                @foreach($perms as $perm)
                                    <label class="flex items-center gap-3 cursor-pointer group">
                                        ...
                                        <span
                                            class="text-sm font-medium text-gray-700 group-hover:text-black dark:text-gray-300 dark:group-hover:text-white transition">
                                            {{-- Formatter: user_create -> Create --}}
